...
export const Footer = () => {
  return (
    <div className="flex items-end w-full text-white bg">
      <footer className="w-full text-white  body-font">
        <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <div className="mt-4">
              <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                <a className="text-white cursor-pointer hover:text-gray-300">
                  <svg
                    fill="currentColor"
          ...
          <div className="flex flex-wrap flex-grow -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
        ...
        <div className="w-full text-white bg-gradient-to-tr from-[#252B30] to-[#191C22]">
